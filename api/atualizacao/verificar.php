...
$updateUrl = getGlobalConfig('INDUZI_UPDATE_URL', '');
...
if (empty($updateUrl)) {
    jsonResponse([
        ...
        'data' => [
            ...
            'msg' => 'URL de atualizacao nao configurada. Defina em Configuracoes > Administracao.',
        ]
    ]);
}
...
// Se a resposta tem campo 'content' com encoding base64, e a GitHub API
if (is_array($responseData) && isset($responseData['content'], $responseData['encoding']) && $responseData['encoding'] === 'base64') {
    ...
    // Resposta direta (servidor proprio, nao GitHub API)
...
// Full changelog mode: retornar todo o changelog sem filtrar
